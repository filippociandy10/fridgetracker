        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FridgeItems_Categories_CategoryId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Beef, chicken, pork", "Meat" },
                    { 3, "Fresh vegetables", "Vegetables" },
                    { 4, "Fresh fruits", "Fruits" },
                    { 5, "Drinks, juices", "Beverages" },
                    { 6, "Leftover meals", "Leftovers" },
                    { 7, "Sauces, dressings", "Condiments" },
                    { 8, "Miscellaneous items", "Other" }
                });

            migrationBuilder.InsertData(
                table: "Settings",
                columns: new[] { "Id", "DarkMode", "ShowNotifications", "UserId", "WarningDays" },
                values: new object[] { 1, false, true, null, 3 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FridgeItems_CategoryId",
                table: "FridgeItems",
                column: "CategoryId");
        }
